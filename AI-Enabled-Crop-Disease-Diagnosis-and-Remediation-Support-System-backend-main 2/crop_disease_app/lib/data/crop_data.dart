...
class CropData {
  static final List<CropModel> crops = [
    ...
    CropModel(
      ...
      name: 'Paddy',
      category: 'paddy',
      imagePath: 'assets/images/crops/paddy.png',
      nameTranslations: {
        'en': 'Paddy',
        'hi': 'धान',
        'te': 'వరి',
    ...
    CropModel(
      ...
      name: 'Wheat',
      category: 'wheat',
      imagePath: 'assets/images/crops/wheat.png',
      nameTranslations: {
        'en': 'Wheat',
        'hi': 'गेहूं',
        'te': 'గోధుమ',
    ...
    CropModel(
      ...
      category: 'vegetables',
      subcategory: 'tomato',
      imagePath: 'assets/images/crops/tomato.png',
      nameTranslations: {
        'en': 'Tomato',
        'hi': 'टमाटर',
        'te': 'టమోటా',
    ...
    CropModel(
      ...
      category: 'vegetables',
      subcategory: 'potato',
      imagePath: 'assets/images/crops/potato.png',
      nameTranslations: {
        'en': 'Potato',
        'hi': 'आलू',
        'te': 'బంగాళాదుంప',
    ...
    CropModel(
      ...
      category: 'fruits',
      subcategory: 'mango',
      imagePath: 'assets/images/crops/mango.png',
      nameTranslations: {
        'en': 'Mango',
        'hi': 'आम',
        'te': 'మామిడి',
    ...
    CropModel(
      ...
      careInstructions: {
        ...
        'ta': 'இறந்த கிளைகளை அகற்றவும். காற்று பாதுகாப்பு அளிக்கவும்.',
      },
      waterRequirements: {
